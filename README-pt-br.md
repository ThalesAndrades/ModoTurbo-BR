<div align="center">
<h1 align="center">ModoTurbo 💸</h1>

<p align="center">
  <a href="https://github.com/ThalesAndrades/ModoTurbo-BR/stargazers"><img src="https://img.shields.io/github/stars/ThalesAndrades/ModoTurbo-BR.svg?style=for-the-badge" alt="Stargazers"></a>
  <a href="https://github.com/ThalesAndrades/ModoTurbo-BR/issues"><img src="https://img.shields.io/github/issues/ThalesAndrades/ModoTurbo-BR.svg?style=for-the-badge" alt="Issues"></a>
  <a href="https://github.com/ThalesAndrades/ModoTurbo-BR/network/members"><img src="https://img.shields.io/github/forks/ThalesAndrades/ModoTurbo-BR.svg?style=for-the-badge" alt="Forks"></a>
  <a href="https://github.com/ThalesAndrades/ModoTurbo-BR/blob/main/LICENSE"><img src="https://img.shields.io/github/license/ThalesAndrades/ModoTurbo-BR.svg?style=for-the-badge" alt="License"></a>
</p>
...
![Interface do ModoTurbo em português brasileiro](docs/webui-pt-br.jpg)
...
|---|---|
| [Instalar-ModoTurbo-DEMO.bat](instaladores/Instalar-ModoTurbo-DEMO.bat) | **Versão DEMO gratuita** — instalação completa em fluxo único |
...
Quer testar o ModoTurbo sem instalar nada? Rode direto no Google Colab — funciona até pelo
navegador do celular:

[![Abrir no Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ThalesAndrades/ModoTurbo-BR/blob/main/docs/ModoTurbo.ipynb)
...
```shell
git clone https://github.com/ThalesAndrades/ModoTurbo-BR.git
```
...
`.\ModoTurbo\models\whisper-large-v3`:
...
- Abra uma [issue](https://github.com/ThalesAndrades/ModoTurbo-BR/issues) ou envie um
  [pull request](https://github.com/ThalesAndrades/ModoTurbo-BR/pulls)
