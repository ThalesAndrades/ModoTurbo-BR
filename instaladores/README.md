...
**[Instalar-ModoTurbo-DEMO.bat](Instalar-ModoTurbo-DEMO.bat)** —
...
| `ModoTurboApp.ps1` | Modo Aplicativo: splash, servidor oculto, janela própria, bandeja |
| `ModoTurboApp.vbs` | Inicialização invisível (sem janela preta) |
