...
تريد تجربة ModoTurbo دون إعداد بيئة محلية؟ شغّله مباشرةً في Google Colab!
...
لاحظ أنك بحاجة لتنفيذ الأوامر التالية في `المجلد الجذر` لمشروع ModoTurbo
...
بعد تنزيل النموذج، فُكّ ضغطه وضع المجلد بالكامل في `.\ModoTurbo\models`،
وينبغي أن يبدو مسار الملف النهائي هكذا: `.\ModoTurbo\models\whisper-large-v3`
