...
免去本地环境配置，点击直接在 Google Colab 中快速体验 ModoTurbo
...
注意需要到 ModoTurbo 项目 `根目录` 下执行以下命令
...
模型下载后解压，整个目录放到 `.\ModoTurbo\models` 里面，
最终的文件路径应该是这样: `.\ModoTurbo\models\whisper-large-v3`
