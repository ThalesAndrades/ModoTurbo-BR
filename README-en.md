...
<p align="center">
  ...
  <a href="https://github.com/harry0703/MoneyPrinterTurbo/blob/main/LICENSE"><img src="https://img.shields.io/github/license/ThalesAndrades/ModoTurbo-BR.svg?style=for-the-badge" alt="License"></a>
</p>

<h3>English | <a href="README-zh.md">简体中文</a> | <a href="README-pt-br.md">Português (Brasil)</a> | <a href="README-ar.md">العربية</a></h3>

<div align="center">
  <a href="https://trendshift.io/repositories/8731" target="_blank"><img src="https://trendshift.io/api/badge/repositories/8731" alt="harry0703%2FModoTurbo | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>
...
Want to try ModoTurbo without setting up a local environment? Run it directly in Google Colab!

[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ThalesAndrades/ModoTurbo-BR/blob/main/docs/ModoTurbo.ipynb)
...
Note that you need to execute the following commands in the `root directory` of the ModoTurbo project
...
After downloading the model, extract it and place the entire directory in `.\ModoTurbo\models`,
The final file path should look like this: `.\ModoTurbo\models\whisper-large-v3`
